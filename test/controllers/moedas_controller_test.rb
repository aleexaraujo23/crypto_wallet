...
class MoedasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moeda" do
    assert_difference('Moeda.count') do
      post moedas_url, params: { moeda: { acronimo: @moeda.acronimo, descricao: @moeda.descricao, url_image: @moeda.url_image, valor_reais: @moeda.valor_reais } }
    end
  ...
  test "should update moeda" do
    patch moeda_url(@moeda), params: { moeda: { acronimo: @moeda.acronimo, descricao: @moeda.descricao, url_image: @moeda.url_image, valor_reais: @moeda.valor_reais } }
